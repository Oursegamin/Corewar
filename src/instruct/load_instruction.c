    ...
    instruct_types_t *types ,int prog_nbr)
{
    if (!types)
        return NULL;
    champion[prog_nbr]->nbr_cycle += op_tab[LD].nbr_cycles;
    ...
    instruct_types_t *types ,int prog_nbr)
{
    if (!types)
        return NULL;
    champion[prog_nbr]->nbr_cycle += op_tab[LLD].nbr_cycles;
    champion[prog_nbr]->PC += 2;
    champion[prog_nbr]->carry = change_carry(champion, prog_nbr);
...
int ldi(corewar_t *corewar, champion_t **champion, int prog_nbr)
{
    ...
    if (!types)
        return KO;
    champion[prog_nbr]->nbr_cycle += op_tab[LDI].nbr_cycles;
    champion[prog_nbr]->PC += 2;
    champion[prog_nbr]->carry = change_carry(champion, prog_nbr);
...
int lldi(corewar_t *corewar, champion_t **champion, int prog_nbr)
{
    ...
    if (!types)
        return KO;
    champion[prog_nbr]->nbr_cycle += op_tab[LLDI].nbr_cycles;
    champion[prog_nbr]->PC += 2;
    champion[prog_nbr]->carry = change_carry(champion, prog_nbr);
